  ...
  return (
    <>
      <SEOHead
        ...
        description="Цены на изделия из камня в Зеленограде от StipStone. Актуальный прайс-лист на столешницы, подоконники, мойки из искусственного камня. Стоимость работ и материалов. ☎ +7 (985) 086-70-21"
